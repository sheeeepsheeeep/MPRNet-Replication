...
def center_crop(img, max_width=1280, max_height=720, mod=8):
    ...
    # Set dimensions to prevent tensor size mismatch 
...
def main():
    ...
    # Point to the Denoising pretrained weights one folder level up
    ...
    # Get ALL images in the current folder (ignores the python script itself)
